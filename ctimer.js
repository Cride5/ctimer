...
function delSolve(row, user){
	...
	for(var i = row; i < iSolve; i++){
		...
		table.rows[i + 5].cells[nSteps + 2].innerHTML = '<a href="#" onclick="delSolve('+i+', true); return false;">x</a>';
		if(i < iSolve - 1){
...
//debug("nSteps = " + nSteps);
	table.rows[idx + 5].cells[nSteps + 2].innerHTML = '<a href="#" onclick="delSolve('+(idx)+', true); return false;">x</a>';
}
